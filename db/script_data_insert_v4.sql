...
(1, 'Encuesta Calorcito ', 'Ahora puedes disfrutar del sabor de México en una forma instantánea y conveniente que te transportará a las reuniones familiares. Más que una sopa instantánea, Calorcito es un apapacho y una celebración de la tradición.', 'calorcito', '1_encuesta_portada.png', '', '', '2023-10-01 00:00:00', '2023-12-31 23:59:59', 'S', 'N', 1, 'S');
...
(21, 1, 'Platícanos con tus palabras qué le cambiarías a Calorcito', 'INPUT', 'N', 8, 'S'),
(4, 1, 'Después de probar Calorcito, ¿Qué pensarías si te dijera que tiene un precio de $25.00?', 'RADIO', 'S', 9, 'S'),
(26, 1, '¿Y por qué dices / crees esto? ', 'INPUT', 'N', 10, 'S'),
(23, 1, '¿Has probado otros productos de sopa similares? Si es así, ¿cómo compararías nuestro producto con los competidores en términos de sabor y calidad?', 'RADIO', 'S', 11, 'S'),
...
(76, 1, 22, 'No me gustó', 'N', 'S', NULL, 4, 'S'),
(80, 1, 23, 'Es mejor en sabor e ingredientes que otras sopas instantáneas', 'N', 'S', NULL, 2, 'S'),
(81, 1, 23, 'Es igual en sabor e ingredientes que otras sopas instantáneas', 'N', 'S', NULL, 2, 'S'),
(82, 1, 23, 'Tiene oportunidades en cuanto a sabor e ingredientes que otras sopas instantáneas', 'N', 'S', NULL, 3, 'S'),
(83, 1, 23, 'No he probado otros productos similares', 'N', 'S', NULL, 4, 'S'),
(40, 1, 5, 'Supermercados<br /> (Walmart, Soriana, Chedraui, etc.)', 'N', 'S', 'tienda1.png;tiendas', 1, 'S'),
(41, 1, 5, 'Tiendas de conveniencia<br /> (OXXO, 7 Eleven, GoMart, etc.)', 'N', 'S', 'tienda2.png;tiendas', 2, 'S'),
(42, 1, 5, 'Tienditas de abarrotes', 'N', 'S', 'tienda3.png;tiendas', 3, 'S'),
(89, 1, 5, 'Bodegas<br /> (Centrales de abasto, Costco, Sams, etc.)', 'N', 'S', 'tienda5.png;tiendas', 4, 'S'),
