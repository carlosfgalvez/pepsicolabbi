    ...
    <div class="card-body">
        ...
        <form method="post" action="<?=site_url('banners/save')?>" enctype="multipart/form-data">
            ...
            <div class="form-group left color-gray font-admin">
                ...
                <input id="tipo" value="<?=$reg['tipo'];?>" class="form-control mb-3" type="text" name="tipo"></input>
                ...
                <input id="url1" value="<?=$reg['url1'];?>" class="form-control mb-3" type="text" name="url1"></input>

                <label for="url2">Url 2</label>
                <input id="url2" value="<?=$reg['url2'];?>" class="form-control mb-3" type="text" name="url2"></input>
