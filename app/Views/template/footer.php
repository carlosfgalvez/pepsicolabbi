<footer>
    <ul class="nav nav-fill d-flex justify-content-center align-items-center">
        <li class="nav-item">
            <a class="nav-link" href="#"><img alt="pepsico" class="img-fluid pepsico"
                    src="<?=$url_base;?>public/ui/images/pepsico.webp" /></a>
        </li>
        <li class="nav-item">
            <span class="nav-link" href="#">&copy;Copyright 2023 PepsiCo, Inc., Todos los Derechos Reservados
