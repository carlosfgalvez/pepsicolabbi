    ...
    <div class="card-body">
        ...
        <form method="post" action="<?=site_url('opciones/saveopc')?>" enctype="multipart/form-data">
            ...
            <div class="form-group left color-gray font-admin">
                ...
                <input id="opcion" value="<?= $reg['opcion'];?>" class="form-control mb-3" type="text" name="opcion"></input>
                ...
                <select name="img_clase" id="img_clase" class="form-control mb-3">
                    <?php echo $clases ;?>
                </select>

                <label for="img_alto">Imagen Alto (Pixeles)</label>
                <input id="img_alto" value="<?= $reg['img_alto'];?>" class="form-control mb-3" type="text"
                    name="img_alto"></input>

                <label for="img_ancho">Imagen Ancho (Pixeles)</label>
                <input id="img_ancho" value="<?= $reg['img_ancho'];?>" class="form-control mb-3" type="text"
