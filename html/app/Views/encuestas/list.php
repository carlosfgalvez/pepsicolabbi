      ...
      <tbody>
        <?php foreach($registros as $reg): ?>
            <tr>
              ...
              <td class="center ">
                <a href="<?=$url_base.'encuestas/edit/'.$reg['idenc'];?>" class="btn btn-primary btn-sm" role="button">Editar</a>
                <a href="<?=$url_base.'encuestas/delete/'.$reg['idenc'];?>" class="btn  btn-outline-danger btn-sm" role="button">Borrar</a></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
