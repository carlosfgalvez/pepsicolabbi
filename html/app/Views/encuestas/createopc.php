...
<div class="card">
  ...
  <?php endif ?>
    ...
    <div class="form-group left color-gray font-admin">
      ...
      <input id="id_pregunta"  value="<?=$idp?>" class="form-control hide" type="text" name="id_pregunta"></input>
      ...
      <input id="img_opcion"  value="<?= old('img_opcion');?>" class="form-control" type="text" name="img_opcion"></input>

      <label for="img_alto">Imagen Alto (Pixeles)</label>
      <input id="img_alto"  value="<?= old('img_alto');?>" class="form-control" type="text" name="img_alto"></input>

      <label for="img_ancho">Imagen Ancho (Pixeles)</label>
      <input id="img_ancho"  value="<?= old('img_ancho');?>" class="form-control" type="text" name="img_ancho"></input>
    ...
    <br/>
    <a href="<?=$url_base.'opciones/0/'.$ideencryp;?>;?>" class="btn btn-outline-warning" role="button">Cancelar</a>
