...
<div class="row">
  ...
  <div class="col-2" style="text-align: right;">Total encuestas</div>
	<div class="col-2 number" style="text-align: left;"><strong><?= number_format($count_encuestas);?></strong> </div>
	<div class="col-4"></div>
</div>
<div class="row">
	<div class="col-4"></div>
  <div class="col-2" style="text-align: right;">Total encuestas vigentes</div>
	<div class="col-2 number" style="text-align: left;"><strong><?= number_format($count_encuestas_vigentes);?></strong> </div>
	<div class="col-4"></div>
</div>
<div class="row">
	<div class="col-4"></div>
  <div class="col-2" style="text-align: right;">Total encuestas enviadas</div>
	<div class="col-2 number" style="text-align: left;"><strong><span id="count_enviadas"><?= number_format($count_enviadas);?></span></strong>
    <?php if ($count_enviadas>0) { ?>
      <a class="btn btn-success btn-sm hide" style="margin-left: 20px;--bs-btn-font-size: 0.600rem!important;" href="<?=$url_base;?>admin/encuestadescarga" id="btnDescargaEncuesta">Descargar</a>
    <?php } ?>
  </div>
	<div class="col-4"></div>
</div>
<div class="row">
  ...
  <div class="col-2" style="text-align: right;">Última encuesta enviada</div>
	<div class="col-2 number" style="text-align: left;" ><strong><span id="ultima_enviada"><?=$enviada_ultima;?></span></strong> </div>
	<div class="col-4"></div>
</div>
...
<div class="row mt-5">
    ...
    <a class="btn btn-outline-secondary" style="margin: 5px;" href="<?=$url_base;?>admin/logdescarga">Log descarga</a>
	</div>
	<div class="col-1"></div>
</div>
...
<script>
    ...
    $('#list_encuestas').on('change', function (e) {
      ...
      if (id!="") { total = get_encuesta_count(id,url); }
    });
