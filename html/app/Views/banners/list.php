      ...
      <tbody>
        <?php foreach($registros as $reg): ?>
            <tr>
              ...
              <td class="center ">
                <a href="<?=$url_base.'banners/edit/'.$reg['id'];?>" class="btn btn-primary btn-sm" role="button">Editar</a>
                <a href="<?=$url_base.'banners/delete/'.$reg['id'];?>" class="btn  btn-outline-danger btn-sm" role="button">Borrar</a></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
